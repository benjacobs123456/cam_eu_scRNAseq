...
# navigate to the wd
cd /rds/project/sjs1016/rds-sjs1016-msgen/10X_RawData/EU_2020/SLX-20198/

# get list of unique samples
sample=$(ls *.fastq.gz | awk -F "_" '{print $1}' | uniq | awk -v x=$SLURM_ARRAY_TASK_ID 'NR==x{print $1}')

cd /rds/project/sjs1016/rds-sjs1016-msgen/bj_scrna/Cambridge_EU_combined/viral_alignment/EU
mkdir $sample
cd $sample
...
# combine fastQ lanes
cat /rds/project/sjs1016/rds-sjs1016-msgen/10X_RawData/EU_2020/SLX-20198/$sample\_S1_L00?_R1_001.fastq.gz > read_1.gz
cat /rds/project/sjs1016/rds-sjs1016-msgen/10X_RawData/EU_2020/SLX-20198/$sample\_S1_L00?_R2_001.fastq.gz > read_2.gz
