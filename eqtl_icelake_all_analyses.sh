...
for source in CSF PBMC;
  do
    for pheno in MS OIND NIND;
      do  
          echo Processing eQTLs for $pheno and $source
          Rscript /rds/project/sjs1016/rds-sjs1016-msgen/bj_scrna/scripts/joint_eu_cam/eqtl_per_celltype.R $SLURM_ARRAY_TASK_ID $pheno $source
      done 
  done
