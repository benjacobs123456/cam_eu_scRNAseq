...
#echo "Processing TCRs"
#Rscript dandelion_preparation.R TCR
echo "Running singularity dandelion for TCRs"
cd /rds/project/sjs1016/rds-sjs1016-msgen/bj_scrna/Cambridge_EU_combined/dandelion_inputs/TCR
singularity run -B $PWD ~/sc-dandelion_latest.sif dandelion-preprocess --meta meta_file.csv --chain TR
